...
{ text: 'прочитать полностью войну и мир ещё раз', image: 'https://code.s3.yandex.net/web-code/procrastinate/5.png' },
...
{ text: 'нарисовать пейзаж города', image: 'https://code.s3.yandex.net/web-code/procrastinate/6.png' },
...
{ text: 'попробовать замочить 5 криперов без брони и оружия', image: 'https://code.s3.yandex.net/web-code/procrastinate/1.gif' },
{ text: 'кушать супчик с грибочками', image: 'https://code.s3.yandex.net/web-code/procrastinate/9.png' },
{ text: 'проверить непрочитанное в Telegram-каналах', image: 'https://code.s3.yandex.net/web-code/procrastinate/10.png' }
];

function getRandomElement(arr) {с
